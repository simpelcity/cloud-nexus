      ...
      <main>
          ...
          <Container className="d-flex flex-column align-items-center justify-content-center my-5">
            <Row className="w-100 mb-3">
              <Col xl={6}>
                ...
                <ListGroup>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Cloud Hosting</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Dedicated Server Hosting</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Managed Server Hosting</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Colocation Services</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Storage Buckets</ListGroup.Item>
                </ListGroup>
              </Col>
              <Col xl={6}>
                <h2 className="fw-bold text-uppercase">
                ...
                <ListGroup>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Performance-Driven</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Security First</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">24/7 Expert Support</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Eco-Friendly Commitment</ListGroup.Item>
                  <ListGroup.Item className="border-0 p-0 fs-5 bg-light">Global Reach</ListGroup.Item>
                </ListGroup>
              </Col>
            </Row>
            <Button variant="primary" href="/services" className="fw-bold text-uppercase text-white rounded-1 fs-5">view services</Button>
          </Container>
        </section>
        <section className="join-about d-flex justify-content-center text-center">
          <Container className="d-flex flex-column align-items-center justify-content-center my-5">
            ...
            <Button variant="primary" href="/contact" className="fw-bold text-uppercase text-white rounded-1 fs-5">get in touch</Button>
          </Container>
        </section>
      </main>
    </>
