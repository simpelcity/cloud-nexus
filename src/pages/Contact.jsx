    ...
    <>
      <main>
        ...
        <section className="cards-contact d-flex justify content-center text-center">
          <Container className="d-flex justify-content-center mb-5" fluid>
            <Row className="w-100 d-flex justify-content-center row-gap-4">
              <Col xl={4}>
                <Card className="border-0 rounded-0 shadow-sm h-100 bg-light">
                  <Card.Body className="d-flex flex-column align-items-center pb-5">
                    ...
                    <Card.Text>
                      <ListGroup>
                        <ListGroup.Item className="border-0 p-0 fs-5 bg-light">
                ...
                <Card className="border-0 rounded-0 shadow-sm h-100">
                  <Card.Body className="d-flex flex-column align-items-center pb-5">
                    ...
                    <Card.Text>
                      ...
                      <ListGroup>
                        <ListGroup.Item className="border-0 p-0 fs-5">
                          <span className="fw-bold">Email:</span>{" "}
