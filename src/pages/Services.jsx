      ...
      <main>
        ...
        <section className="services d-flex justify-content-center text-center">
          <Container className="d-flex flex-column align-items-center justify-content-center my-5">
            <h2 className="fw-bold text-uppercase">services</h2>
        ...
        <section className="why-us-services d-flex justify-content-center text-center text-xl-start bg-light">
          <Container className="d-flex align-items-center my-5">
            <Row className="d-flex justify-content-center row-gap-4 w-100">
              <Col xs={12} md={9} xl={8}>
                <h2 className="fw-bold text-uppercase">why choose cloud nexus?</h2>
                <p className="m-0">
              ...
              <Col xs={12} md={3} xl={2} className="d-flex justify-content-center align-items-center">
                <ListGroup className="text-start">
                  <ListGroup.Item className="border-0 p-0 bg-light mt-xl-4">
        ...
        <section className="hosting-services d-flex justify-content-center text-start">
          <Container className="my-5 d-flex justify-content-center">
            <Row className="d-flex justify-content-center row-gap-4 w-100">
              <Col xs={12} md={3} xl={3} className="d-flex align-items-center justify-content-center">
                <ListGroup className="">
              ...
              <Col xs={12} md={8} xl={8} className="text-center text-lg-start">
                <h2 className="fw-bold text-uppercase">custom hosting solutions for unique requirements</h2>
                <p className="">
